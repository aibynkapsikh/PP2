...
player = pygame.transform.scale(player, (100, 100))  # Уменьшаем размер
...
running = True
while running:
    screen.fill((118, 100, 91))  # Обновляем экран
    
    screen.blit(square, (70, 70))
    screen.blit(text_surface, (300, 310))  
    screen.blit(player, (player_x, player_y))  # Отображаем игрока по новым координатам
